    ...
    <div>
          ...
          <tbody>
            {files.map((file) => (
              <tr key={file._id}>
                ...
                <td>
                  <button type="button" className="btn btn-warning mx-1" onClick={() => handleUpdate(file._id)}>Update</button>
                  <button type="button" className="btn btn-warning mx-1" onClick={() => handleDownload(file._id)}>Download</button>
                  <button type="button" className="btn btn-danger mx-1" onClick={() => handleDelete(file._id)}>Delete</button>
                </td>
              </tr>
            ))}
          </tbody>
        ...
        <div className="row justify-content-center pt-3">
          <div className="col-lg-6">
            <form className="border shadow p-3">
              ...
              <div>
                <button className="btn btn-primary mt-4" onClick={handleSubmitUpdate}>Update File</button>
              </div>
            </form>
          </div>
        </div>
      ...
      {/* End Update form */}
       ...
       {/* Start Search Option  */}
        ...
        <div>
        <button class="btn btn-primary mt-2" onClick={handleSearch}>Search</button>
        </div>
